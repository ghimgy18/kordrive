...
<body>
    ...
    <div class="row">
        ...
        <div id="edit" class="col text-center">
            <h3 class="mb-2" style="text-align: start;">View Parent</h3>
            ...
            <div id="container">
                <button type="submit" class="btn btn-primary" style="width: 200px;" onclick="location.href='./add_parent.php'">Add Parent</button>
            </div>
